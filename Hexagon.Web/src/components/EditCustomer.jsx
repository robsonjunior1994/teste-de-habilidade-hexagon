...
const EditCustomer = () => {
        ...
        const fetchCustomer = async () => {
            ...
            try {
                ...
                if (response.data.isSuccess) {
                    ...
                    setError(response.data.message || 'Failed to fetch customer');
                }
            } catch (error) {
                console.error('Error fetching customer:', error);
                setError(error.response?.data?.message || error.message || 'Error loading customer');
            } finally {
                setLoading(false);
            }
        };
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setError(error.response?.data?.message || error.message || 'Error updating customer');
        } finally {
            setSaving(false);
        }
    };
